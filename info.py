...
USERNAME = environ.get('USERNAME', "https://telegram.me/tmv_admin_bot")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002037384930'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+Inf5n7z8rXpmZDQ9')
...
START_IMG = environ.get('START_IMG', 'https://i.ibb.co/vCy3jVB4/photo-2025-04-28-14-05-32-7498364938574888964.jpg')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002343414940'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002343414940'))
URL = environ.get('URL', 'mytestbot-jvdfhbj.com')
STICKERS_IDS = ('CAACAgUAAxkBAAKSoWgPgkx8QVtLgps5Y1kWBnMz6iDgAAIUFAACwbzBVcSCIoaVRDr1HgQ').split()
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002037384930')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002037384930'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002584496698'))
